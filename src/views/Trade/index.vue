  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        收货人：<span>{{ defaultAddress.fullAddress }}</span>
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      userAddressList: (state) => state.trade.trade.userAddressList || [],
      detailArrayList: (state) => state.trade.trade.detailArrayList || []
    }),
    totalNum() {
      let totalNum = 0
      this.detailArrayList.forEach((item) => (totalNum += item.skuNum))
      return totalNum || 0
    },
    defaultAddress() {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      const result = await this.$API.reqSubmitOrder(data)
      if (result.code === 200) {
