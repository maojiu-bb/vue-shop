        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="changeIcon('1')">
                  <a>
                    综合
                    <span
                      v-show="isOne"
                      :class="{
                        ...
                        'el-icon-arrow-up': isUp
                      }"
                    >
                    </span>
                  </a>
                </li>
                <li :class="{ active: isTow }" @click="changeIcon('2')">
                  <a>
                    价格
                    <span
                      v-show="isTow"
...
export default {
  ...
  methods: {
    ...
    // attrInfo 自定义事件
    attrInfo(item, itemVal) {
      // ["属性ID:属性值:属性名"]
      const props = `${item.attrId}:${itemVal}:${item.attrName}`
      // 判断是否已经存在
